...
public class XPathParser extends Parser {
	...
	public static final int
		...
		QTEXT=18, WORD=19, AND=20, OR=21, NOT=22, WS=23;
	public static final int
		RULE_abspath = 0, RULE_doc = 1, RULE_relpath = 2, RULE_filter = 3, RULE_filename = 4, 
		RULE_tagname = 5, RULE_strconst = 6;
	private static String[] makeRuleNames() {
		return new String[] {
			"abspath", "doc", "relpath", "filter", "filename", "tagname", "strconst"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, "QTEXT", "WORD", "AND", "OR", "NOT", 
			"WS"
		};
	}
	...
	public static class AbspathContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XPathListener ) ((XPathListener)listener).enterAbspath(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XPathListener ) ((XPathListener)listener).exitAbspath(this);
		}
	}
	...
	public static class RelpathContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XPathListener ) ((XPathListener)listener).enterRelpath(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XPathListener ) ((XPathListener)listener).exitRelpath(this);
		}
	}
	...
	private RelpathContext relpath(int _p) throws RecognitionException {
		...
		int _startState = 4;
		enterRecursionRule(_localctx, 4, RULE_relpath, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new RelpathContext(_parentctx, _parentState);
	...
	public static class FilenameContext extends ParserRuleContext {
		public TerminalNode QTEXT() { return getToken(XPathParser.QTEXT, 0); }
	...
	public static class TagnameContext extends ParserRuleContext {
		public TerminalNode WORD() { return getToken(XPathParser.WORD, 0); }
